...
<div class="wrap about-wrap">
	...
	<p class="woocommerce-actions">
		...
		<a class="docs button button-primary" href="<?php echo esc_url( apply_filters( 'woocommerce_docs_url', 'http://docs.woocommerce.com/documentation/subscriptions/', 'woocommerce-subscriptions' ) ); ?>"><?php echo esc_html_x( 'Documentation', 'short for documents', 'woocommerce-subscriptions' ); ?></a>
		<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://docs.woocommerce.com/documentation/subscriptions/version-2-1/" data-text="I just updated to WooCommerce Subscriptions v2.1, woot!" data-via="WooCommerce" data-size="large" data-hashtags="WooCommerce">Tweet</a>
		...
		<div class="feature-section two-col">
			...
			<div class="col last-feature feature-copy">
				...
				<p class="woocommerce-actions">
					...
					<a class="button" href="http://docs.woocommerce.com/documentation/subscriptions/reports/"><?php echo esc_html_x( 'Learn More', 'learn more link to subscription reports documentation', 'woocommerce-subscriptions' ); ?></a>
				</p>
			</div>
		</div>
		...
		<div class="feature-section two-col">
			...
			<div class="col feature-copy">
				...
				<p class="woocommerce-actions">
					...
					<a class="button" href="http://docs.woocommerce.com/documentation/subscriptions/failed-payment-retry/"><?php echo esc_html_x( 'Learn More', 'learn more link to failed payment retry documentation', 'woocommerce-subscriptions' ); ?></a>
				</p>
			</div>
		</div>
		...
		<div class="feature-section under-the-hood three-col">
			<div class="col">
				...
				<p><?php
					...
					printf( esc_html__( '%sLearn more &raquo;%s', 'woocommerce-subscriptions' ), '<a href="http://docs.woocommerce.com/documentation/subscriptions/develop/failed-payment-retry/">', '</a>' ); ?>
				</p>
			</div>
			<div class="col">
