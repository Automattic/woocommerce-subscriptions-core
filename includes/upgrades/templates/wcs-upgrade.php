...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?>>
	...
	<body class="wp-core-ui">
		...
		<div id="update-messages">
			...
			<p><?php printf( esc_html__( 'The full update process for the %s subscriptions on your site will take approximately %s to %s minutes.', 'woocommerce-subscriptions' ), esc_html( $subscription_count ), esc_html( $estimated_duration ), esc_html( $estimated_duration * 2 ) ); ?></p>
			<?php endif; ?>
