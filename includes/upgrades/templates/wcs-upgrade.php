...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?>>
	...
	<body class="wp-core-ui">
		...
		<div id="update-messages">
			...
			<p><?php printf( esc_html__( 'Because the site is on WPEngine, the batch might be smaller, and will take at most 60 seconds.', 'woocommerce-subscriptions' ), esc_html( $batch_size ) ); ?></p>
			<?php endif; ?>
			<?php endif; ?>
