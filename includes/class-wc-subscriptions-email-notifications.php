...
class WC_Subscriptions_Email_Notifications {
	...
	public static function add_emails( $email_classes ) {
		...
		$email_classes['WCS_Email_Customer_Notification_Free_Trial_Expiry']     = new WCS_Email_Customer_Notification_Free_Trial_Expiry();
		$email_classes['WCS_Email_Customer_Notification_Subscription_Expiring'] = new WCS_Email_Customer_Notification_Subscription_Expiring();
