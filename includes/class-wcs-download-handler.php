...
class WCS_Download_Handler {
	...
	public static function init() {
		...
		remove_action( 'woocommerce_order_item_meta_end', array( __CLASS__, 'add_get_item_downloads_status_override' ), 10, 3 );
	}
	...
	/**
	 * Used to add/remove the `get_item_downloads_status_override()` filter within the `email-order-items.php` template
	 *
