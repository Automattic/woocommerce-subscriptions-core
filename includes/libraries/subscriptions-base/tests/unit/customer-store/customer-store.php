 ...
 */
class WCS_Customer_Store_Test extends WCS_Customer_Store_Test_Base {
	...
	public function test_instance_filter() {
		$this->clear_instance();
		add_filter( 'wcs_customer_store_class', array( $this, 'get_instance_class' ) );
		$this->assertInstanceOf( $this->get_instance_class(), WCS_Customer_Store::instance() );
		remove_filter( 'wcs_customer_store_class', array( $this, 'get_instance_class' ) );
		$this->clear_instance();
	}
	...
	public function get_instance_class() {
		return 'WCS_Customer_Test_Store';
	}
