 ...
 */
class WCS_Customer_Store_CPT_Test extends WCS_Customer_Store_Test_Base {
	...
	public function test_get_users_subscription_ids_none() {
		$this->assertEquals( array(), self::$store->get_users_subscription_ids( $this->customer_id_without_subscriptions ) );
	}
