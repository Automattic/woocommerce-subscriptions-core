 ...
 *
 */
class WCS_Cart_Functions_Unit_Tests extends WCS_Unit_Test_Case {
	...
	*/
	public function test_wcs_cart_pluck_item_field( $cart ) {
		...
		$cart_item = array( 'subscription_period_interval' => 1, 'subscription_period' => 'month' );
