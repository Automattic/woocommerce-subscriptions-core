...
class WCS_User_Functions_Unit_Tests extends WCS_Unit_Test_Case {
	...
	*/
	public function test_wcs_user_has_subscription() {
		...
		$subscription2 = WCS_Helper_Subscription::create_subscription( array( 'status' => 'active', 'start_date' => '2017-06-01 00:00:00', 'customer_id' => $user_id1 ) );
		...
		$subscription3 = WCS_Helper_Subscription::create_subscription( array( 'status' => 'expired', 'start_date' => '2017-06-01 00:00:00', 'customer_id' => $user_id2 ) );
