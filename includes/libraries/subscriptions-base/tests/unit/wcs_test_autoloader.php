...
class WCS_Test_Autoloader extends WCS_Unit_Test_Case {
	...
	public function setUp() {
		$this->autoloader = new WCS_Autoloader( WCS_Unit_Tests_Bootstrap::instance()->plugin_dir );
	}
	...
	public function should_autoload_provider() {
		return array(
			...
			array( 'WC_Report_Retention_Rate', true ),
			array( 'WC_Report_Upcoming_Recurring_Revenue', true ),
			array( 'WC_Order_Item_Pending_Switch', true ),
	...
	public function relative_class_path_provider() {
		return array(
			...
			array( 'WCS_Retry_Store', '/includes/abstracts/' ),
			...
			array( 'WCS_Report_Cache_Manager', '/includes/admin/reports/' ),
			array( 'WCS_Report_Dashboard', '/includes/admin/reports/' ),
			array( 'WCS_Report_Retention_Rate', '/includes/admin/reports/' ),
			array( 'WCS_Report_Subscription_By_Customer', '/includes/admin/reports/' ),
			array( 'WCS_Report_Subscription_By_Product', '/includes/admin/reports/' ),
			array( 'WCS_Report_Subscription_Events_By_Date', '/includes/admin/reports/' ),
			array( 'WCS_Report_Subscription_Payment_Retry', '/includes/admin/reports/' ),
			array( 'WCS_Report_Upcoming_Recurring_Revenue', '/includes/admin/reports/' ),
			array( 'WC_Report_Retention_Rate', '/includes/admin/reports/deprecated/' ),
			array( 'WC_Report_Subscription_By_Customer', '/includes/admin/reports/deprecated/' ),
			array( 'WC_Report_Subscription_By_Product', '/includes/admin/reports/deprecated/' ),
			array( 'WC_Report_Subscription_Events_By_Date', '/includes/admin/reports/deprecated/' ),
			array( 'WC_Report_Subscription_Payment_Retry', '/includes/admin/reports/deprecated/' ),
			array( 'WC_Report_Upcoming_Recurring_Revenue', '/includes/admin/reports/deprecated/' ),
			array( 'WC_REST_Subscription_Notes_Controller', '/includes/api/' ),
			array( 'WC_REST_Subscriptions_Controller', '/includes/api/' ),
			array( 'WC_API_Subscriptions_Customers', '/includes/api/legacy/' ),
			array( 'WC_API_Subscriptions', '/includes/api/legacy/' ),
			...
			array( 'WCS_Cart_Early_Renewal', '/includes/early-renewal/' ),
			array( 'WCS_Early_Renewal_Manager', '/includes/early-renewal/' ),
			...
			array( 'WCS_Retry_Admin', '/includes/payment-retry/' ),
			array( 'WCS_Retry_Email', '/includes/payment-retry/' ),
			array( 'WCS_Retry_Post_Store', '/includes/payment-retry/' ),
			array( 'WCS_Retry_Rule', '/includes/payment-retry/' ),
			array( 'WCS_Retry_Rules', '/includes/payment-retry/' ),
			array( 'WCS_Retry', '/includes/payment-retry/' ),
	...
	/**
	 * Test that our path mapping provides the correct location for our legacy classes.
	 *
	 * The API dynamically changes the location of some classes when needed.
	 *
	 * @author       Jeremy Pry
	 *
	 * @param string $class_name
	 * @param string $expected_path
	 *
	 * @dataProvider legacy_relative_class_path_provider
	 */
	public function test_legacy_relative_class_path( $class_name, $expected_path ) {
		$this->autoloader->use_legacy_api( true );
		$get_relative_class_path = $this->get_accessible_protected_method( $this->autoloader, 'get_relative_class_path' );
		$path                    = $get_relative_class_path->invoke( $this->autoloader, strtolower( $class_name ) );
		$this->assertEquals( $expected_path, $path, "{$class_name} get_relative_class_path() test" );
	}
	...
	/**
	 * Data provider for the test_legacy_relative_class_path() method.
	 *
	 * @author Jeremy Pry
	 * @return array
	 */
	public function legacy_relative_class_path_provider() {
		return array(
			array( 'WC_REST_Subscription_Notes_Controller', '/includes/api/legacy/' ),
			array( 'WC_REST_Subscriptions_Controller', '/includes/api/legacy/' ),
		);
	}
	...
	public function get_file_name_provider() {
		return array(
			...
			array( 'WCS_Retry_Store', 'abstract-wcs-retry-store.php' ),
			...
			array( 'WCS_Report_Retention_Rate', 'class-wcs-report-retention-rate.php' ),
			...
			array( 'WCS_Report_Upcoming_Recurring_Revenue', 'class-wcs-report-upcoming-recurring-revenue.php' ),
			array( 'WC_Report_Retention_Rate', 'class-wc-report-retention-rate.php' ),
			...
			array( 'WC_Report_Upcoming_Recurring_Revenue', 'class-wc-report-upcoming-recurring-revenue.php' ),
			...
			array( 'WC_API_Subscriptions_Customers', 'class-wc-api-subscriptions-customers.php' ),
			array( 'WC_API_Subscriptions', 'class-wc-api-subscriptions.php' ),
			array( 'WC_Order_Item_Pending_Switch', 'class-wc-order-item-pending-switch.php' ),
			...
			array( 'WCS_Cart_Early_Renewal', 'class-wcs-cart-early-renewal.php' ),
			array( 'WCS_Early_Renewal_Manager', 'class-wcs-early-renewal-manager.php' ),
