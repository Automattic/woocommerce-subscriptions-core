...
class WC_Subscriptions_Admin {
	...
	public static function enqueue_styles_scripts() {
		...
		if ( $is_woocommerce_screen ) {
			...
			wp_enqueue_script( 'woocommerce_subscriptions_admin', plugin_dir_url( WC_Subscriptions::$plugin_file ) . 'assets/js/admin/admin.js', $dependencies, filemtime( WC_Subscriptions_Base_Plugin::get_instance()->get_base_plugin_directory() . '/assets/js/admin/admin.js' ) );
