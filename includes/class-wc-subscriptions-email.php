...
class WC_Subscriptions_Email {
	...
	public static function order_details( $order, $sent_to_admin = false, $plain_text = false, $email = '' ) {
		...
		$order_items_table_args = array(
			...
			'show_purchase_note'  => ( $sent_to_admin ) ? false : $order->has_status( apply_filters( 'woocommerce_order_is_paid_statuses', array( WCS_Order_Status::PROCESSING, WCS_Order_Status::COMPLETED ) ) ),
			'show_image'          => '',
			'image_size'          => '',
