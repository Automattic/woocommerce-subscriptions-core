...
class WC_Subscriptions_Order {
	...
	*/
	...
	public static function maybe_record_subscription_payment( $order_id, $old_order_status, $new_order_status ) {
		...
		$paid_statuses   = array( apply_filters( 'woocommerce_payment_complete_order_status', WCS_Order_Status::PROCESSING, $order_id, $order ), WCS_Order_Status::PROCESSING, WCS_Order_Status::COMPLETED );
		$unpaid_statuses = apply_filters( 'woocommerce_valid_order_statuses_for_payment', array( WCS_Order_Status::PENDING, WCS_Order_Status::ON_HOLD, WCS_Order_Status::FAILED ), $order );
		...
		foreach ( $subscriptions as $subscription ) {
			...
			} elseif ( WCS_Order_Status::FAILED === $new_order_status ) {
	...
	*/
	...
	public static function maybe_autocomplete_order( $new_order_status, $order_id, $order = null ) {
		...
		if ( 0 === $order_id || WCS_Order_Status::PROCESSING !== $new_order_status ) {
		...
		if ( wcs_order_contains_resubscribe( $order ) ) {
			$new_order_status = WCS_Order_Status::COMPLETED;
