...
interface IWCS_Retry_Store_Factory {
	public static function database_store();

	public static function post_store();
}

/**
 * Class WCS_Retry_Store_Factory
 */
class WCS_Retry_Store_Factory implements IWCS_Retry_Store_Factory {
	/**
