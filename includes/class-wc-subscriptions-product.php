...
class WC_Subscriptions_Product {
	...
	public static function bulk_edit_variations( $bulk_action, $data, $variable_product_id, $variation_ids ) {
		...
		if ( WC_Subscriptions::is_woocommerce_pre( '2.5' ) && ! self::is_subscription( $variable_product_id ) ) {
			return;
		}
		...
		if ( ! WC_Subscriptions::is_woocommerce_pre( '2.5' ) && empty( $_POST['security'] ) || ! wp_verify_nonce( $_POST['security'], 'bulk-edit-variations' ) || 'variable-subscription' !== $_POST['product_type'] ) {
			return;
		}
