...
class WC_Subscriptions_Admin {
	...
	public static function subscription_pricing_fields() {
		...
		$chosen_price        = $post->get_meta( '_subscription_price' );
		$chosen_interval     = $post->get_meta( '_subscription_period_interval' );
		...
		if ( ! $chosen_period = $post->get_meta( '_subscription_period' ) ) {
			$chosen_period = 'month';
		}
