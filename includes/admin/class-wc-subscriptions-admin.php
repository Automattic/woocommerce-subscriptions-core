...
class WC_Subscriptions_Admin {
	...
	public static function enqueue_styles_scripts() {
		...
		if ( $is_woocommerce_screen || $is_activation_screen || 'edit-product' == $screen->id || ( 'wc-reports' === $_GET['page'] && 'subscriptions' === $_GET['tab'] ) ) {
...
<div class="wrap">
	...
	/**
	 * Filter the "Subscriptions" based on a list of ids
	 *
	 * @param string $where
	 * @return string
	 * @since 2.6
