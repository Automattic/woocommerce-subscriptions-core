<?php
/**
 * Customer Notification: Free trial is about to expire email.
 *
	...
	<p>
		...
		echo wp_kses(
			...
			// translators: %1$s: name of the blog, %2$s: link to checkout payment url, note: no full stop due to url at the end
				_x( 'Your free trial subscription for XYZ on %1$s is about to expire. To keep receiving the goodies, subscribe over here: %2$s', 'In customer renewal invoice email', 'woocommerce-subscriptions' ),
